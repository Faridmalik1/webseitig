...
export function Features() {
  return (
    <section id="features" className="bg-[#151515] py-10 md:py-16 px-8">
      <div className="max-w-[1568px] mx-auto px-6 md:px-8">
        ...
        <div className="text-center mb-14 md:mb-18">
          ...
          <p className="text-white/45 text-[16px] sm:text-[20px] leading-relaxed">
          ...
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="flex items-end gap-3 mb-5">
                <div className="w-8 h-[2px] mb-2 bg-[#C8F135] rounded-full" />
              ...
              <p className="text-[#888888] text-[14px] sm:text-[16px] leading-relaxed">
                {step.desc}
              </p>
            </motion.div>
          ))}
