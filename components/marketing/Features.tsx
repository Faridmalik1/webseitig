...
export function Features() {
  return (
    <section id="features" className="bg-[#151515] py-10 md:py-16 px-6 md:px-8">
      <div className="max-w-[1568px] mx-auto w-full">
        ...
        <div className="text-center mb-14 md:mb-18">
          ...
          <h2 className="text-white text-[24px] sm:text-[32px] lg:text-[40px] xl:text-[48px] leading-tight mb-4">
           Einfacher als Sie denken. Fertig in 7 Tagen.
          </h2>
          <p className="text-white/45 text-[16px] lg:text-[20px] 3xl:text-[24px] leading-relaxed">
...
<div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-0">
  {steps.map((step, i) => (
    ...
    >
              ...
              <h3 className="text-white text-[20px] sm:text-[24px] 3xl:text-[24px] leading-snug mb-3 whitespace-pre-line">
                {step.title}
              </h3>
              <p className="text-[#888888] text-[16px] lg:text-[20px] 3xl:text-[24px] leading-relaxed">
                {step.desc}
              </p>
            </motion.div>
          ))}
