...
export function CTABanner() {
  ...
  return (
    <div className="px-6 md:px-8 py-10 md:py-16">
    <section
      className="relative overflow-hidden max-w-[1568px] rounded-[40px] mx-auto w-full py-20 md:py-24 text-center bg-[#C8F135]"
    >
      <img
